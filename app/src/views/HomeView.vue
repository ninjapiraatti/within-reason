<template>
	<div>
		<section class="relative w-full bg-gradient-to-r from-aqua-300 via-aqua-500 to-aqua-700">
			<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col items-center justify-center">
				<div class="w-full flex flex-col md:flex-row items-center md:justify-start">
					<img :src="tuoppiImg" alt="Tuomas Louekari" class="w-1/4 h-auto rounded-full" />
					<div class="text-center md:text-left md:items-center">
						<h1 class="text-4xl md:text-6xl font-thin text-black mt-6 md:mt-0 md:ml-8">Tuomas Louekari</h1>
